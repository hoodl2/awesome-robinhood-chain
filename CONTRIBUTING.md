...
- Project name and a direct official URL. A HoodL2 profile URL is optional source context.
...
Link project names directly to canonical websites, documentation or repositories. Add a HoodL2 research link only when it provides useful context, rather than linking every entry to a profile. Avoid referral URLs, shortened links, unsupported rankings, yield promises and claims of Robinhood endorsement. A project appearing in this list does not establish an audit or a recommendation to transact.
